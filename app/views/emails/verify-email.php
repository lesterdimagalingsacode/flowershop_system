...
<head>
    ...
    <title>Verify your email — Petal &amp; Soul</title>
</head>
                            ...
                            <tr>
                                <td style="padding:44px 48px 40px;">
                                    ...
                                    <p style="margin:0 0 28px;color:#7a6e63;font-size:15px;line-height:1.7;">
                                        Welcome to Petal &amp; Soul! We're delighted to have you with us.
                                        Please verify your email address to complete your registration and start
                                        exploring our curated collection of blooms.
                                    </p>
                                        ...
                                        <tr>
                                            <td style="padding:12px 16px;">
                                                <p style="margin:0;color:#8a7355;font-size:12px;line-height:1.6;">
                                                    🔒 This link is secure and unique to your account.
                            ...
                            <tr>
                                <td style="background:#f7f3ee;border-top:1px solid #e2d9cc;padding:20px 48px;text-align:center;">
                                    ...
                                    <p style="margin:0;color:#c8bdb0;font-size:11px;">
                                        You received this because you created an account on our website.
                                    </p>
                                </td>
                            </tr>
                        </table>
